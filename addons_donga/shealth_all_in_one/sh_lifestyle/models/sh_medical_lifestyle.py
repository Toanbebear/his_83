...
class SHealthRecreationalDrug(models.Model):
    _name = "sh.medical.recreational.drugs"
...
class SHealthPatient(models.Model):
    ...
    drugs = fields.Many2many('sh.medical.recreational.drugs', 'sh_medical_patient_recreational_drugs_rel', 'partner_id', 'sh_drugs_recreational_id', string='Recreational Drugs', help="Name of drugs that the patient consumes")
