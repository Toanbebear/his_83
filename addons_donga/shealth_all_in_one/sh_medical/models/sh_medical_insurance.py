...
class SHealthInsuranceType(models.Model):
    _name = 'sh.medical.insurance.type'
...
class SHealthInsurance(models.Model):
    _name = 'sh.medical.insurance'
    ...
    patient = fields.Many2one('sh.medical.patient', string='Patient', required=True)
    start_date = fields.Date(string='Start Date', required=True)
    exp_date = fields.Date(string='Expiration date', required=True)
    ins_type = fields.Many2one('sh.medical.insurance.type', string='Insurance Type', required=True)
    ...
    def create(self, vals):
        ...
        insurance = super(SHealthInsurance, self).create(vals)
        return insurance
    ...
    def unlink(self):
        ...
        return super(SHealthInsurance, self).unlink()
