...
class InheritSHealthPrescriptions(models.Model):
    ...
    def action_sync_his_prescription(self):
        ...
        if self.doctor.token_his_physician:
            ...
            _logger.info("*************************************Response from API: %s",
                         request_content.encode('utf-8').decode('unicode-escape'))
            ...
            if 'status' in response and response['status'] == 'success':
                time.sleep(3)
                url_sale = 'http://10.10.10.197:9989/api/eprescription/sale?api=2b11k2h3foes9f0809zdn398f0fasdmkj30'
