...
REFRESH_RULE_MODELS = [
    ...
    'sh.medical.imaging','sh.medical.lab.test','sh.medical.patient.log',
    'sh.medical.surgery','sh.medical.specialty','sh.medical.inpatient',
    'sh.medical.evaluation','sh.medical.prescription'
]
