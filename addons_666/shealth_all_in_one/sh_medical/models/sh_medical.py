...
class SHealthPhysicianDegree(models.Model):
    ...
    education_level = fields.Selection([('saudaihoc', 'Sau đại học'), ('daihoc', 'Đại học'), ('caodang', 'Cao Đẳng'), ('trungcap', 'Trung Cấp'), ('socap', 'Sơ Cấp')], string='Cấp học', translate=True, default='trungcap')
...
class SHealthPrescriptions(models.Model):
    ...
    def create(self, vals):
        if vals.get('prescription_line'):
            ...
            vals['name'] ='00874' + year_last_two_digits + sequence + '-' + 'c'
