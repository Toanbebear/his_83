...
""",
    ...
    "data": [
        ...
        'sh_medical/views/sh_medical_service_specialty_view.xml',
        ...
        'sh_surgery/views/report_sh_surgery_view.xml',
       ...
       'sh_payment/views/inherit_institution_view.xml',
        ...
        'sh_report/wizard/sokhambenh_report.xml',
        'sh_report/wizard/soravaovien_report.xml',
